...
public:
	...
	vector<_Region> GetRealRegions(char *filename,CRect& marginReal);
	...
	void PreDrawRegions(char *filename,vector<_Region>& vecRegions,CRect& RegionMargin,map<int,_Cluster>& mapCluster,int rate);

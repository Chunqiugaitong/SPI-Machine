...
namespace Gxmc_Gerber
{
	...
	public:
		...
		//显示mark点
		void DisplayMarkPoint(CDC& dc,ScreenStruct screen,const vector<CGxmcDatabase::Mark>& m_vecMark);
		vector<CGxmcDatabase::Mark> GetMarkPoints();
		//获取数据库中提取的Fov数据集
